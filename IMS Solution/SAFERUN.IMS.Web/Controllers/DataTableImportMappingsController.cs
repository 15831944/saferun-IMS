...
namespace SAFERUN.IMS.Web.Controllers
{
    public class DataTableImportMappingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,EntitySetName,FieldName,TypeName,SourceFieldName,IsEnabled,RegularExpression")] DataTableImportMapping dataTableImportMapping)
        {
        ...
        [HttpPost]
        //[ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,EntitySetName,FieldName,TypeName,SourceFieldName,IsEnabled,RegularExpression")] DataTableImportMapping dataTableImportMapping)
        {
            if (ModelState.IsValid)
            {
